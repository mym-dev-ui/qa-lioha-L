...
import { Eye, EyeOff, LogIn, User, Loader2, Mail, Lock } from "lucide-react";
            ...
            <CardContent className="pt-2">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  {emailInvalid && (
                    <p id="email-help" className="text-xs text-red-400">
                ...
                <div className="space-y-2">
                  ...
                  {passwordInvalid && (
                    <p id="password-help" className="text-xs text-red-400">
